...
/**
 * Client for the Cron Expression Parser API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/cronparser?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/cronparser';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CronparserClient] {$message}\n";
        }
    }
}
