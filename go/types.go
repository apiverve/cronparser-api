// Package cronparser provides a Go client for the Cron Expression Parser API.
//
// For more information, visit: https://apiverve.com/marketplace/cronparser?utm_source=go&utm_medium=readme
package cronparser
...
// Request contains the parameters for the Cron Expression Parser API.
//
// Parameters:
//   - expression (required): string - The cron expression to parse (5-field or 6-field format)
type Request struct {
...
// ResponseData contains the data returned by the Cron Expression Parser API.
...
// FieldsData represents the fields object.
type FieldsData struct {
	Second SecondData `json:"second"`
	Minute MinuteData `json:"minute"`
	Hour HourData `json:"hour"`
	DayOfMonth DayOfMonthData `json:"dayOfMonth"`
	Month MonthData `json:"month"`
	DayOfWeek DayOfWeekData `json:"dayOfWeek"`
}

// SecondData represents the second object.
...
// MinuteData represents the minute object.
...
// HourData represents the hour object.
...
// DayOfMonthData represents the dayOfMonth object.
type DayOfMonthData struct {
	Expression string `json:"expression"`
	Description string `json:"description"`
	Values []int `json:"values"`
}

// MonthData represents the month object.
...
// DayOfWeekData represents the dayOfWeek object.
...
// FrequencyData represents the frequency object.
