...
const (
	baseURL        = "https://api.apiverve.com/v1/cronparser"
	defaultTimeout = 30 * time.Second
)

// Client is the Cron Expression Parser API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Cron Expression Parser API client.
...
// Execute makes a request to the Cron Expression Parser API with typed parameters.
//
