# Cron Expression Parser Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:cronparser-api:1.1.13'
}
```
...
```java
import com.apiverve.cronparser.CronExpressionParserAPIClient;
import com.apiverve.cronparser.APIResponse;
import com.apiverve.cronparser.APIException;

// Initialize the client
CronExpressionParserAPIClient client = new CronExpressionParserAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("expression", "0 9 * * 1-5");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/cronparser](https://docs.apiverve.com/ref/cronparser)
...
- **Documentation:** [https://docs.apiverve.com/ref/cronparser](https://docs.apiverve.com/ref/cronparser)
- **Issues:** [GitHub Issues](https://github.com/apiverve/cronparser-api/issues)
