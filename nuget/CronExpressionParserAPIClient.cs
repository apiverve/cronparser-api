...
namespace APIVerve.API.CronExpressionParser
{
    ...
    /// <summary>
    /// Client for the CronExpressionParser API
    /// </summary>
    public class CronExpressionParserAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/cronparser";
        ...
        public CronExpressionParserAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CronExpressionParserAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CronExpressionParserAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, CronExpressionParserQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(CronExpressionParserQueryOptions options)
        {
        ...
        public ResponseObj Execute(CronExpressionParserQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(CronExpressionParserQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(CronExpressionParserQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(CronExpressionParserQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(CronExpressionParserQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(CronExpressionParserQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(CronExpressionParserQueryOptions options)
        {
